...
using CertificateManagementApi.Service.EmailService;
...
namespace Dansnom.EmailServices
{
	...
	public MailService (IConfiguration configuration)
	{
        ...
        public void SendEMailAsync(MailRequest mailRequest)
        {
            ...
            string SenderName = "Certificate Management";
            string SenderEmail = "olukola9@gmail.com";
            ...
            string ReplyToName = "Certificate Management";
            string ReplyToEmail = "olukola9@gmail.com";
